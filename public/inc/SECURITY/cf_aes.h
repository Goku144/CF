...
#define CF_AES_128_KEY_SIZE 16
#define CF_AES_192_KEY_SIZE 24
#define CF_AES_256_KEY_SIZE 32
#define CF_AES_MAX_ROUND_KEYS 60

static const cf_u8 CF_AES_MIX_COLUMN[4][4] =
{
  {0x02, 0x03, 0x01, 0x01},
  {0x01, 0x02, 0x03, 0x01},
  {0x01, 0x01, 0x02, 0x03},
...
static const cf_u8 CF_AES_INV_MIX_COLUMN[4][4] =
{
  {0x0E, 0x0B, 0x0D, 0x09},
  {0x09, 0x0E, 0x0B, 0x0D},
  {0x0D, 0x09, 0x0E, 0x0B},
...
static const cf_u8 CF_AES_RCJ[15] =
{
  0x00, 0x01, 0x02, 0x04, 
  0x08, 0x10, 0x20, 0x40, 
  0x80, 0x1B, 0x36, 0x6C, 
...
static const cf_u8 CF_AES_SBOX[256] =
{
...
static const cf_u8 CF_AES_INV_SBOX[256] =
{
...
typedef enum cf_aes_key_size
{
  CF_AES_KEY_128 = CF_AES_128_KEY_SIZE,
  CF_AES_KEY_192 = CF_AES_192_KEY_SIZE,
  CF_AES_KEY_256 = CF_AES_256_KEY_SIZE,
} cf_aes_key_size;

typedef struct cf_aes
{
  cf_u32 round_keys[CF_AES_MAX_ROUND_KEYS];
  cf_u8 rounds;
  cf_u8 words;
